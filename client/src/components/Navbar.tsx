    ...
    <>
      <header className="sticky top-0 z-50 w-full pointer-events-none px-3 sm:px-6 pt-3 sm:pt-4">
        ...
        >
          ...
          <div className="relative z-10 flex items-center justify-between gap-1.5 sm:gap-3 pl-2 sm:pl-5 pr-2 sm:pr-4">
            {/* ─── 2. Logo & Brand Tagline ─── */}
            <button
              onClick={() => handleNavigate('home')}
              className="flex items-center space-x-2 text-left group focus:outline-none shrink-0 max-w-[180px] sm:max-w-[240px] xl:max-w-[200px] 2xl:max-w-none"
            ...
            <div className="flex items-center gap-1 sm:gap-2 shrink-0">
              ...
              <button
                ...
                className="2xl:hidden flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-slate-100 text-slate-700 hover:bg-slate-200 dark:bg-white/10 dark:text-white/80 dark:hover:bg-white/15 transition-colors shrink-0"
