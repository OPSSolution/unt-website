...
export const ProductsPage: React.FC<ProductsPageProps> = ({
  ...
  const data = sections.products_page ?? {};
        ...
        <ScrollReveal animation="up">
          <div className="relative z-10 max-w-[1700px] w-full mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 text-center space-y-3">
            ...
            <p className="text-slate-600 dark:text-slate-300 text-sm sm:text-base max-w-2xl mx-auto">
              {data.subheadline ?? 'Direct-from-factory imported goods pre-audited for Cambodian Ministry compliance, Khmer labeling standards, and volume trade distribution.'}
            </p>
          </div>
        </ScrollReveal>
      </section>
