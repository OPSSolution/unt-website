      ...
      {featuredArticle && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            ...
            className="group cursor-pointer rounded-3xl bg-white border border-slate-200 overflow-hidden shadow-xl hover:border-emerald-400 transition-all grid grid-cols-1 lg:grid-cols-2 items-center text-left"
          >
            <div className="relative aspect-video lg:aspect-square overflow-hidden bg-slate-100">
              <img
            ...
            <div className="p-8 space-y-4 text-slate-900">
              <div className="flex items-center space-x-3 text-xs text-emerald-700 font-semibold">
              ...
              <h2 className="text-2xl sm:text-3xl font-display font-bold group-hover:text-emerald-700 transition-colors leading-tight">
              ...
              <div className="flex items-center space-x-3 pt-2">
                ...
                <div className="text-xs">
                  <div className="font-bold text-slate-900">{featuredArticle.author.name}</div>
                  <div className="text-[10px] text-slate-500">{featuredArticle.author.role}</div>
                </div>
              </div>

              <div className="pt-4 flex items-center space-x-2 text-xs font-bold text-emerald-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredArticles.map((article) => (
            <div
              ...
              className="group cursor-pointer rounded-3xl bg-white border border-slate-200 overflow-hidden shadow-md hover:shadow-xl hover:border-emerald-400 transition-all flex flex-col justify-between text-left"
            >
              <div>
              ...
              <div className="px-6 pb-6 pt-2 flex items-center justify-between text-xs font-bold text-emerald-700 border-t border-slate-100">
