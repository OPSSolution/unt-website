...
export function HomePartners({ partners }: { partners: PartnerLogo[] }) {
  const partnerCards = (copy: number) => partners.map((partner) => (
    ...
    >
      <div className="relative h-14 mb-3 flex items-center justify-center overflow-hidden">
        ...
        <div className="space-y-6">
          ...
          <div className="marquee-mask overflow-hidden py-2">
            <div className="marquee-track flex w-max">
              <div className="flex gap-5 pr-5">{partnerCards(0)}</div>
              <div className="flex gap-5 pr-5" aria-hidden="true">{partnerCards(1)}</div>
              {/*
